...
/*const attack = function (attackingPlayer, defendingPlayer, baseDamage, variableDamage) {
  ...
  return `${attackingPlayer} hits ${defendingPlayer} for ${totalDamage}. ${defendingPlayer} has ${defendingPlayer.health} remaining.`
...
const attack = (attackingPlayer, defendingPlayer, baseDamage, variableDamage) => {
  ...
  const totalDamage = baseDamage + randomDamage
  defendingPlayer.health -= totalDamage
  return `${attackingPlayer.name} hits ${defendingPlayer.name} for ${totalDamage}. ${defendingPlayer.name} has ${defendingPlayer.health} remaining.`
